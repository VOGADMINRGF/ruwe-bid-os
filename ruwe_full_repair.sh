...
echo "🔧 RUWE Bid OS – Full Repair & Design Restore startet..."

# =========================================
# 1. Tailwind CSS neu installieren & konfigurieren
# =========================================
echo "🎨 Repariere Tailwind CSS Setup..."
    ...
    <html lang="de">
      <body>
        <nav className="bg-black text-white px-6 py-4 flex gap-6 items-center">
          <span className="font-bold text-lg">RUWE <span className="text-orange-500">Bid OS</span></span>
          <div className="flex gap-4 text-sm">
            {nav.map((n) => (
              <Link key={n} href={n === "dashboard" ? "/" : `/${n}`} className="hover:text-orange-400">
...
# =========================================
# 3. Prisma Client Fix (Prisma v7 kompatibel)
# =========================================
echo "🗄️ Repariere Prisma Client..."
...
# =========================================
# 4. Seed Script in JavaScript (kein TS-Fehler mehr)
# =========================================
mkdir -p prisma
...
# =========================================
# 5. Modernes Dashboard mit funktionierendem Design
# =========================================
  ...
  return (
    <div>
      ...
      <div className="card">
        ...
        <div className="kpi text-orange-500">{Math.round(weighted / 1000)}k €</div>
      </div>
    </div>
  );
}
...
# =========================================
git add .
git commit -m "fix: restore Tailwind design, fix Prisma v7 client, seed script and dashboard layout" || true
git push origin main || true

echo "✅ Design, Prisma und Dashboard erfolgreich repariert!"
echo "👉 Starte die App neu mit: npm run dev"
