...
echo "🔧 Repair storage + migration + demo completeness"
...
npm run build || true
git add lib/storage.ts scripts/migrate-json-to-mongo.mjs
git commit -m "fix: complete demo fallback typing and migrate all source/demo collections to mongo" || true
git push origin main || true

echo "✅ Storage/Migration sauber repariert."
