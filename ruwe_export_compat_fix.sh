...
echo "🔧 Fixe Export-Kompatibilität für format/sourceLogic ..."
...
npm run build || true
git add lib/format.ts lib/sourceLogic.ts
git commit -m "fix: restore backward-compatible format exports and region-trade aggregation" || true
git push origin main || true

echo "✅ Export-Kompatibilität repariert."
